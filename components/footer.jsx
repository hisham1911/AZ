      ...
      <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="flex flex-col md:items-end">
            ...
            <ul className="space-y-3 text-xs">
              <li className="flex items-start group">
                ...
                <span className="text-gray-300/90 text-xs group-hover:text-blue-200 transition-colors duration-300">
        ...
        <div className="border-t border-blue-800/30 py-4">
          <div className="flex justify-center items-center space-x-6">
            <h4 className="font-semibold text-xs uppercase tracking-wider text-blue-200 mr-2">
              Follow Us:
            </h4>
            <div className="flex space-x-4">
              <a
                ...
                aria-label="Facebook"
                className="group p-2 rounded-full bg-blue-800/30 hover:bg-blue-700/50 transition-all duration-300"
              >
                <Facebook className="h-4 w-4 text-blue-300 group-hover:text-white transition-colors duration-300" />
              </a>
              <a
                ...
                className="group p-2 rounded-full bg-blue-800/30 hover:bg-blue-700/50 transition-all duration-300"
              >
                <Instagram className="h-4 w-4 text-blue-300 group-hover:text-white transition-colors duration-300" />
              </a>
              <a
                ...
                className="group p-2 rounded-full bg-blue-800/30 hover:bg-blue-700/50 transition-all duration-300"
              >
                <Linkedin className="h-4 w-4 text-blue-300 group-hover:text-white transition-colors duration-300" />
              </a>
            </div>
          </div>
        </div>
